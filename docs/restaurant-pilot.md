...
1. Apply all migrations through `20260926050000_restaurant_rewards_transfers_alerts` to a staging database, test the workflow, and confirm backup and restore procedures. The migrations preserve existing restaurant and scan records and add account transfers, bar positions, configurable reward types, alert support, catalog, promotion, fulfillment, invoice-request, and internal timing fields.
